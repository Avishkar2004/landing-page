...
const Hero = () => {
  const { btnText, compText, image, subtitle, title } = hero;

  return (
    <section className="min-h-[900px] py-12">
      <div className="container mx-auto min-h-[900px] flex justify-center items-center">
        <div className="flex flex-col lg:gap-x-[30px] gap-y-8 lg:gap-y-0 lg:flex-row items-center justify-center lg:text-left">
          {/* text */}
          <div className="flex-1">
            ...
            <div
              ...
              data-aos-delay="700"
            >
              <button className="btn btn-md lg:btn:lg bg-accent flex justify-center items-center lg:gap-x-4">
                {btnText}
              </button>
